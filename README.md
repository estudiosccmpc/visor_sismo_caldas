...
- Los puntos turquesa corresponden a **239 registros** ubicados mediante una dirección o lugar georreferenciado.
- Los puntos naranjas agrupan **117 registros** ubicados en el centroide oficial de su municipio.
...
- Corte de respuestas: **18 de agosto de 2026**.
- Universo: **356 registros en 21 municipios**.
- Todos los registros tienen una coordenada para visualización: 239 georreferenciados por dirección o lugar y 117 ubicados de manera referencial en centroides municipales.
- Nueve fechas de reporte están marcadas como “por revisar” o “sin fecha válida”; por eso el corte se basa en la fecha de respuesta.
